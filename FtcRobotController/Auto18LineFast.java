...
@Config
@Autonomous
public class Auto18LineFast extends OpMode {
        ...
        if (rrData.getRobotData().isPendingPosition()){
            ...
            if (rrData.getRobotData().isAwaitingTrajectoryGeneration()){
                ...
                if (rrData.getRobotData().isStartedLeft()){
                    ...
                    TrajectoryActionBuilder shootThird = rrData.getDrive().actionBuilder(RobotConstantsV2.GATE_MIDDLE_LINE_OPEN_BLUE)
                            .setTangent(Math.toRadians(90))
                    ...
                    TrajectoryActionBuilder shootGate = rrData.getDrive().actionBuilder(RobotConstantsV2.GATE_INTAKE_BLUE)
                            .setTangent(Math.toRadians(90))
                            .splineToLinearHeading(shootingPos,Math.toRadians(180), new TranslationalVelConstraint(RobotConstantsV2.AUTO_FAST_SPEED), new ProfileAccelConstraint(RobotConstantsV2.MIN_ACCEL_SPEED,RobotConstantsV2.MAX_ACCEL_SPEED));
                ...
                //Trajectory Right
                    ...
                    TrajectoryActionBuilder shootThird = rrData.getDrive().actionBuilder(RobotConstantsV2.GATE_MIDDLE_LINE_OPEN_RED)
                            .setTangent(Math.toRadians(270))
                            .splineToLinearHeading(shootingPos,Math.toRadians(180), new TranslationalVelConstraint(RobotConstantsV2.AUTO_FAST_SPEED), new ProfileAccelConstraint(RobotConstantsV2.MIN_ACCEL_SPEED,RobotConstantsV2.MAX_ACCEL_SPEED));
                    ...
                    TrajectoryActionBuilder shootGate = rrData.getDrive().actionBuilder(RobotConstantsV2.GATE_INTAKE_RED)
                            .setTangent(Math.toRadians(270))
                            .splineToLinearHeading(shootingPos,Math.toRadians(180), new TranslationalVelConstraint(RobotConstantsV2.AUTO_FAST_SPEED), new ProfileAccelConstraint(RobotConstantsV2.MIN_ACCEL_SPEED,RobotConstantsV2.MAX_ACCEL_SPEED));
