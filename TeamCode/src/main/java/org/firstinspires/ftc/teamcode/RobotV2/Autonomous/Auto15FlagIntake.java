...
@Config
@Autonomous
public class Auto15FlagIntake extends OpMode {
        ...
        Actions.runBlocking(
                new ParallelAction(
                        ...
                        new SequentialAction(
                                ...
                                rrData.flagException(buildBear[4]),
                                rrData.flagException(buildBear[5]),

                                buildBear[6],
                                buildBear[7],

                                rrData.flagExceptionProc(buildBear[8]),
                                rrData.flagExceptionProc(buildBear[9]),
